...
public enum Casings implements ICasing {
    ...
    PTFEPipeCasing
        (() -> GregTechAPI.sBlockCasings8, 1, 176),
    MiningNeutroniumCasing
        (() -> GregTechAPI.sBlockCasings8, 2, 176),
    MiningBlackPlutoniumCasing
        (() -> GregTechAPI.sBlockCasings8, 3, 176),
    ExtremeEngineIntakeCasing
        (() -> GregTechAPI.sBlockCasings8, 4, 176),
    EuropiumReinforcedRadiationProofMachineCasing
        (() -> GregTechAPI.sBlockCasings8, 5, 176),
    AdvancedRhodiumPlatedPalladiumMachineCasing
        (() -> GregTechAPI.sBlockCasings8, 6, 176),
    AdvancedIridiumPlatedMachineCasing
        (() -> GregTechAPI.sBlockCasings8, 7, 176),
    MagicalMachineCasing
        (() -> GregTechAPI.sBlockCasings8, 8, 176),
    HSSSTurbineCasing
        (() -> GregTechAPI.sBlockCasings8, 9, 176),
    RadiantNaquadahAlloyCasing
        (() -> GregTechAPI.sBlockCasings8, 10, 176),
    BasicPhotolithographicFrameworkCasing
        (() -> GregTechAPI.sBlockCasings8, 11, 176),
    ReinforcedPhotolithographicFrameworkCasing
        (() -> GregTechAPI.sBlockCasings8, 12, 176),
    RadiationProofPhotolithographicFrameworkCasing
        (() -> GregTechAPI.sBlockCasings8, 13, 176),
    InfinityCooledCasing
        (() -> GregTechAPI.sBlockCasings8, 14, 176),

    CentrifugeCasing
        (() -> ModBlocks.blockCasingsMisc, 0, 64),
    StructuralCokeOvenCasing
        (() -> ModBlocks.blockCasingsMisc, 1, 64),
    HeatResistantCokeOvenCasing
        (() -> ModBlocks.blockCasingsMisc, 2, 64),
    HeatProofCokeOvenCasing
        (() -> ModBlocks.blockCasingsMisc, 3, 64),
    MaterialPressMachineCasing
        (() -> ModBlocks.blockCasingsMisc, 4, 64),
    ElectrolyzerCasing
        (() -> ModBlocks.blockCasingsMisc, 5, 64),
    WireFactoryCasing
        (() -> ModBlocks.blockCasingsMisc, 6, 64),
    MacerationStackCasing
        (() -> ModBlocks.blockCasingsMisc, 7, 64),
    MatterGenerationCoil
        (() -> ModBlocks.blockCasingsMisc, 8, 64),
    MatterFabricatorCasing
        (() -> ModBlocks.blockCasingsMisc, 9, 64),
    IronPlatedBricks
        (() -> ModBlocks.blockCasingsMisc, 10, 64),
    MultitankExteriorCasing
        (() -> ModBlocks.blockCasingsMisc, 11, 64),
    HastelloyNReactorCasing
        (() -> ModBlocks.blockCasingsMisc, 12, 64),
    Zeron100ReactorShielding
        (() -> ModBlocks.blockCasingsMisc, 13, 64),
    BlastSmelterHeatContainmentCoil
        (() -> ModBlocks.blockCasingsMisc, 14, 64),
    BlastSmelterCasingBlock
        (() -> ModBlocks.blockCasingsMisc, 15, 64),
