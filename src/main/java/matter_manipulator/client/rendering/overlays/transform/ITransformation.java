...
public abstract class ITransformation<Vector, Transformation extends ITransformation> {
    ...
    /**
     * Creates a TransformationList composed of this transformation followed by t If this is a TransformationList, the
     * transformation will be appended and this returned
     */
    public abstract Transformation with(Transformation t);

    /**
     * Returns a simplified transformation that performs this, followed by next. If such a transformation does not
     * exist, returns null
     */
    ...
    /**
     * Returns true if this transformation is redundant, eg. Scale(1, 1, 1), Translation(0, 0, 0) or Rotation(0, a, b,
     * c)
     */
