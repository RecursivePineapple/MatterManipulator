...
import matter_manipulator.core.item.ItemMeta;
import matter_manipulator.core.item.ItemSupplier;
...
public class LazyItem extends Lazy<ImmutableItemMeta> implements ImmutableItemMeta {
    ...
    public LazyItem(IMod mod, String itemName, int meta) {
        super(() -> {
            ...
            Item item = Item.REGISTRY.getObject(new ResourceLocation(mod.getID(), itemName));
    ...
    public LazyItem(IMod mod, ItemStackSupplier getter) {
        super(() -> {
            ...
            if (stack == null || stack == ItemStack.EMPTY) return null;

            return new ItemMeta(stack.getItem(), ItemUtils.getStackMeta(stack));
        });
    ...
    public boolean matches(ItemStack stack) {
        ...
        return matches(stack.getItem(), ItemUtils.getStackMeta(stack));
    }
