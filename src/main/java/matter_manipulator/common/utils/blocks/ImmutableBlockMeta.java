...
/// It can be assumed that the values of [#getBlock()] and [#getBlockMeta()] will never change for this
...
public interface ImmutableBlockMeta {
    ...
    /// The value of this must not change while this object is exposed via an API.
    ///
    /// @return The block's metadata stored in this pair. May be [OreDictionary#WILDCARD_VALUE].
    int getBlockMeta();
    ...
    /// @param meta  The meta. If this parameter or [#getBlockMeta()] equals [OreDictionary#WILDCARD_VALUE]
